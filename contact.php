// Your form processing logic (save, mail, etc.)
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($response_data->success) {
        if (array_key_exists('email', $_POST)) {
            ...
            $stmt = $conn->prepare("INSERT INTO promo (name, phone, mail, message, created_at) VALUES (?, ?, ?, ?, ?)");
...
$mail = new PHPMailer;
    ...
    $mail->addAddress('maheshsellerrocket@gmail.com', 'Kannan');
